...
//    dateFormatterTime.locale = myLocale
//
//    dateFormatterTime.dateFormat = "HH:mm"
    ...
    override func viewDidLoad() {
        ...
        let itemOne = [titleKey : "Starts", dateKey : NSDate()] as [String : Any]
        let itemTwo = [titleKey : "Ends", dateKey : NSDate()] as [String : Any]
//        let itemThree = [titleKey : "Repeat", dateKey : NSDate()] as [String : Any]
//        let itemThree = [titleKey : "End Date", dateKey : NSDate()] as [String : Any]
//        let itemFour = [titleKey : "Repeat", dateKey : NSDate()] as [String : Any]
